...
df_CustTable = readFromDeltaPath("Sales/CustTable")
display(df_CustTable)

# COMMAND ----------

# DBTITLE 1,write to UC-bronze layer
saveToDeltaToCatalog(df_CustTable, "dev_catalog", "bronze", "Custtable")
...
df = spark.read.table("dev_catalog.bronze.custtable")
display(df)