...
df_Currency = readFromDeltaPath("Others/Currency")
display(df_Currency)

# COMMAND ----------

# DBTITLE 1,write to UC-bronze layer
saveToDeltaToCatalog(df_Currency, "dev_catalog", "bronze", "Currency")
...
df = spark.read.table("dev_catalog.bronze.currency")
display(df)