...
df_PurchItem = readFromDeltaPath("Purchase/PurchItem")
display(df_PurchItem)

# COMMAND ----------

# DBTITLE 1,write to UC-bronze layer
saveToDeltaToCatalog(df_PurchItem, "dev_catalog", "bronze", "PurchItem")
...
df = spark.read.table("dev_catalog.bronze.purchitem")
display(df)