...
df_WorkerTable = readFromDeltaPath("Hr/WorkerTable")
display(df_WorkerTable)

# COMMAND ----------

# DBTITLE 1,write to UC-bronze layer
saveToDeltaToCatalog(df_WorkerTable, "dev_catalog", "bronze", "WorkerTable")
...
df = spark.read.table("dev_catalog.bronze.workertable")
display(df)