...
df_partyAddress = readFromDeltaPath("Purchase/PartyAddress")
display(df_partyAddress)

# COMMAND ----------

# DBTITLE 1,write to UC-bronze layer
saveToDeltaToCatalog(df_partyAddress, "dev_catalog", "bronze", "partyAddress")
...
df = spark.read.table("dev_catalog.bronze.partyAddress")
display(df)