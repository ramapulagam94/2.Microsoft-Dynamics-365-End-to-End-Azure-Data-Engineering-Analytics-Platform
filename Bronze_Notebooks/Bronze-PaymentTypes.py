...
df_PaymentTypes = readFromDeltaPath("Sales/PaymentTypes")
display(df_PaymentTypes)

# COMMAND ----------

# DBTITLE 1,write to UC-bronze layer
saveToDeltaToCatalog(df_PaymentTypes, "dev_catalog", "bronze", "PaymentTypes")
...
df = spark.read.table("dev_catalog.bronze.paymenttypes")
display(df)