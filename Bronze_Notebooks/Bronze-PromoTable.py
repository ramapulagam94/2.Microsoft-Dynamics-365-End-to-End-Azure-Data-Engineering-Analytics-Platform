...
df_PromoTable = readFromDeltaPath("Sales/PromoTable")
display(df_PromoTable)

# COMMAND ----------

# DBTITLE 1,write to UC-bronze layer
saveToDeltaToCatalog(df_PromoTable, "dev_catalog", "bronze", "PromoTable")
...
df = spark.read.table("dev_catalog.bronze.promotable")
display(df)