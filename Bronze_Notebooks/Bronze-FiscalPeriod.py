...
df_FiscalPeriod = readFromDeltaPath("Others/FiscalPeriod")
display(df_FiscalPeriod)

# COMMAND ----------

# DBTITLE 1,write to UC-bronze layer
saveToDeltaToCatalog(df_FiscalPeriod, "dev_catalog", "bronze", "FiscalPeriod")
...
df = spark.read.table("dev_catalog.bronze.fiscalperiod")
display(df)